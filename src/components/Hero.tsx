        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center md:text-left space-y-6">
            ...
            <h2 className="text-lg sm:text-xl md:text-2xl text-primary-foreground/90 font-light">
              Microsoft 365 &amp; Azure Cloud Security Engineer
            </h2>
            <p className="text-base sm:text-lg text-primary-foreground/80 leading-relaxed max-w-md mx-auto md:mx-0">
              I specialize in securing Microsoft 365 and Azure environments —
              implementing Conditional Access, Intune compliance, and Microsoft
              Defender to protect identities, endpoints, and data. With a
              foundation in software engineering and system administration, I
              design resilient, automated security solutions aligned with
            ...
            <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4 mt-4">
              <Button
                ...
                variant="secondary"
                size="lg"
                className="group transform transition-transform hover:scale-105 w-full sm:w-auto"
              >
                <a href="/Senahid-Ramic-CV.pdf" download>
          ...
          <div className="flex-shrink-0 relative mb-8 md:mb-0 group">
            <div className="relative w-64 mt-24 sm:w-72 md:w-96 h-64 sm:h-72 md:h-96 rounded-full overflow-hidden 
              ...
              <img 
                src={CVimg} 
                alt="Senahid Ramic - Cloud Security Engineer" 
