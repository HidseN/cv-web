  ...
  return (
    <footer className="bg-primary text-primary-foreground py-12 relative overflow-hidden">
      ...
      <div className="container mx-auto px-7 relative z-10">
        <div className="flex flex-col md:flex-row md:justify-between gap-10">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-6">
            ...
            <p className="text-primary-foreground/80 leading-relaxed max-w-xs">
              Passionate IT System Administrator with BSc in Software Engineering dedicated to creating innovative solutions and exceptional digital experiences. Always learning, always building.
            </p>
        ...
        {/* Copyright */}
        <div className="text-center text-primary-foreground/80 text-bold pt-2">
          <p className="flex items-center justify-center gap-2 neon-glow flex-wrap">
            © {currentYear} Senahid Ramic - made with <Heart className="h-4 w-4 text-red-500 animate-neon-pulse" /> and lots of coffee.
          </p>
        </div>
      </div>
      ...
      <style>{`
        ...
        @keyframes neon-pulse {
          0%, 100% { text-shadow: 0 0 4px rgba(255,0,0,0.6), 0 0 8px rgba(255,0,0,0.4); }
          50% { text-shadow: 0 0 10px rgba(255,0,0,0.8), 0 0 20px rgba(255,0,0,0.6); }
        }
        .neon-glow { transition: text-shadow 0.3s ease-in-out; }
